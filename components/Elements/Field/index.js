...
const style = {
    ...
    default: `form-input border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent  rounded-md w-full p-3 h-16 text-lg`,
};
    ...
    (
        ...
        return (
            <div className={`${style.container} ${disabled ? 'opacity-50' : ''}`}>
                <label htmlFor={name} className="form-label mb-1 text-lg text-gray-400">
                    {label}
